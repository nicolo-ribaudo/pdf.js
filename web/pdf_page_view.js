 ...
 *   part of the page that is close to the viewport.
...
class PDFPageViewBase {
  ...
  _createCanvas(injectCanvas, hideUntilComplete = false) {
...
class PDFPageView extends PDFPageViewBase {
  ...
  constructor(options) {
    ...
    this.enableDetailCanvas = options.enableDetailCanvas || false;
